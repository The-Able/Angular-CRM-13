...
import {EmailEditComponent} from './views/admin/components/email-edit/email-edit.component'
...
@NgModule({
    ...
    entryComponents: [MatDialogComponent, MatNewGridComponent, BucketEditComponent, PasswordComponent, EmailEditComponent,
        PhoneEditComponent, FarmBulkContact, EmailViewComponent, CreateNoteComponent, AppPdfViewerComponent  ],
    imports: [
        AppRoutingModule,
