...
} from '../../src/app/samples/gauges/bullet-graph-animation/bullet-graph-animation.component';
import {
    BulletGraphBackgroundComponent
} from '../../src/app/samples/gauges/bullet-graph-background/bullet-graph-background.component';
import {
    BulletGraphLabelsComponent
} from '../../src/app/samples/gauges/bullet-graph-labels/bullet-graph-labels.component';
import {
    BulletGraphMeasuresComponent
} from '../../src/app/samples/gauges/bullet-graph-measures/bullet-graph-measures.component';
import {
    BulletGraphRangesComponent
} from '../../src/app/samples/gauges/bullet-graph-ranges/bullet-graph-ranges.component';
import {
    BulletGraphScaleComponent
} from '../../src/app/samples/gauges/bullet-graph-scale/bullet-graph-scale.component';
import {
    BulletGraphTickmarksComponent
} from '../../src/app/samples/gauges/bullet-graph-tickmarks/bullet-graph-tickmarks.component';
import {
    LinearGaugeAnimationComponent
} from '../../src/app/samples/gauges/linear-gauge-animation/linear-gauge-animation.component';
import {
    LinearGaugeBackingComponent
} from '../../src/app/samples/gauges/linear-gauge-backing/linear-gauge-backing.component';
import {
    LinearGaugeLabelsComponent
} from '../../src/app/samples/gauges/linear-gauge-labels/linear-gauge-labels.component';
import {
    LinearGaugeNeedleComponent
} from '../../src/app/samples/gauges/linear-gauge-needle/linear-gauge-needle.component';
import {
    LinearGaugeRangesComponent
} from '../../src/app/samples/gauges/linear-gauge-ranges/linear-gauge-ranges.component';
import {
    LinearGaugeScaleComponent
} from '../../src/app/samples/gauges/linear-gauge-scale/linear-gauge-scale.component';
import {
    LinearGaugeTickmarksComponent
} from '../../src/app/samples/gauges/linear-gauge-tickmarks/linear-gauge-tickmarks.component';
import {
    RadialGaugeAnimationComponent
} from '../../src/app/samples/gauges/radial-gauge-animation/radial-gauge-animation.component';
import {
    RadialGaugeBackingComponent
} from '../../src/app/samples/gauges/radial-gauge-backing/radial-gauge-backing.component';
import {
    RadialGaugeLabelsComponent
} from '../../src/app/samples/gauges/radial-gauge-labels/radial-gauge-labels.component';
import {
    RadialGaugeNeedleComponent
} from '../../src/app/samples/gauges/radial-gauge-needle/radial-gauge-needle.component';
import {
    RadialGaugeRangesComponent
} from '../../src/app/samples/gauges/radial-gauge-ranges/radial-gauge-ranges.component';
import {
    RadialGaugeScaleComponent
} from '../../src/app/samples/gauges/radial-gauge-scale/radial-gauge-scale.component';
import {
    RadialGaugeTickmarksComponent
} from '../../src/app/samples/gauges/radial-gauge-tickmarks/radial-gauge-tickmarks.component';
