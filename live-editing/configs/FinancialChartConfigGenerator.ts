...
} from '../../src/app/samples/financial-chart/axis-types/financial-chart-axis-types.component';
import {
    FinancialChartCustomIndicatorsComponent
} from '../../src/app/samples/financial-chart/custom-indicators/financial-chart-custom-indicators.component';
import {
    FinancialChartCustomTooltipsComponent
} from '../../src/app/samples/financial-chart/custom-tooltips/financial-chart-custom-tooltips.component';
import {
    FinancialChartHighFrequencyComponent
} from '../../src/app/samples/financial-chart/high-frequency/financial-chart-high-frequency.component';
import {
    FinancialChartHighVolumeComponent
} from '../../src/app/samples/financial-chart/high-volume/financial-chart-high-volume.component';
import {
    FinancialChartIndicatorTypesComponent
} from '../../src/app/samples/financial-chart/indicator-types/financial-chart-indicator-types.component';
import {
    FinancialChartMultipleDataComponent
} from '../../src/app/samples/financial-chart/multiple-data/financial-chart-multiple-data.component';
import {
    FinancialChartOverviewComponent
} from '../../src/app/samples/financial-chart/overview/financial-chart-overview-sample.component';
import { FinancialChartPanesComponent } from '../../src/app/samples/financial-chart/panes/financial-chart-panes.component';
import {
    FinancialChartPerformanceComponent
} from '../../src/app/samples/financial-chart/performance/financial-chart-performance.component';
import { FinancialDataService } from '../../src/app/samples/financial-chart/services/financial-data.service';
import { GenerateHourlyPricesService } from '../../src/app/samples/financial-chart/services/generate-hourly-prices.service';
import { GenerateOhlcPricesService } from '../../src/app/samples/financial-chart/services/generate-ohlc-prices.service';
import { StockDataService } from '../../src/app/samples/financial-chart/services/stock-data.service';
import { FinancialChartTitlesComponent } from '../../src/app/samples/financial-chart/titles/financial-chart-titles.component';
import {
    FinancialChartTrendlinesComponent
} from '../../src/app/samples/financial-chart/trendlines/financial-chart-trendlines.component';
import {
    FinancialChartVolumeTypeComponent
} from '../../src/app/samples/financial-chart/volume-type/financial-chart-volume-type.component';
