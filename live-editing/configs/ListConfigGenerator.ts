...
import { ListSample1Component } from '../../src/app/samples/list/list-sample-1/list-sample-1.component';
import { ListSample2Component } from '../../src/app/samples/list/list-sample-2/list-sample-2.component';
import { ListSample3Component } from '../../src/app/samples/list/list-sample-3/list-sample-3.component';
import { ListSample4Component } from '../../src/app/samples/list/list-sample-4/list-sample-4.component';
import { ListSample5Component } from '../../src/app/samples/list/list-sample-5/list-sample-5.component';
import { ListSample6Component } from '../../src/app/samples/list/list-sample-6/list-sample-6.component';
import { ListComponent } from '../../src/app/samples/list/list.component';
