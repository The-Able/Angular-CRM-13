...
import { CategoryChartOverviewComponent } from '../../src/app/samples/category-chart/overview/category-chart-overview-sample.component';
import {
    CategoryChartHighVolumeComponent,
} from '../../src/app/samples/category-chart/high-volume/category-chart-high-volume-sample.component';
import {
    CategoryChartHighFrequencyComponent,
} from '../../src/app/samples/category-chart/high-frequency/category-chart-high-frequency-sample.component';
import {
    CategoryChartCustomTooltipsComponent,
} from '../../src/app/samples/category-chart/custom-tooltips/category-chart-custom-tooltips-sample.component';
import {
    CategoryChartConfigOptionsComponent,
} from '../../src/app/samples/category-chart/config-options/category-chart-config-options-sample.component';
import {
    CategoryChartAxisOptionsComponent,
} from '../../src/app/samples/category-chart/axis-options/category-chart-axis-options-sample.component';
