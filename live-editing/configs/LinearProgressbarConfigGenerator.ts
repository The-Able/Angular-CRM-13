...
} from '../../src/app/samples/linear-progressbar/linear-progressbar-sample-1/linear-progressbar-sample-1.component';
import {
    LinearProgressbarSample2Component
} from '../../src/app/samples/linear-progressbar/linear-progressbar-sample-2/linear-progressbar-sample-2.component';
import {
    LinearProgressbarComponent
} from '../../src/app/samples/linear-progressbar/linear-progressbar.component';
