...
const ANGULAR_CLI_TEMPLATE_PATH = path.join(__dirname, "../templates/angular-cli.json.element");
const ANGULAR_CLI_TEMPLATE_CSS_SUPPORT_PATH =
    path.join(__dirname, "../templates/angular-cli-css-support.json.element");
const MAIN_TS_FILE_PATH = path.join(__dirname, "../templates/main.ts.element");
